...
# Auto-generate config.js from Replit Secrets
groq_key = os.environ.get('GROQ_API_KEY', '')
ow_key   = os.environ.get('OPENWEATHER_API_KEY', '')
if groq_key or ow_key:
    pathlib.Path(os.path.join(FRONTEND_DIR, 'config.js')).write_text(
...
def status():
    return {"status": "ok", "message": "KisanAI Running!"}
